...
Originally `nowt()` took dots `...`, but Hadley helpfully [pointed
out](https://twitter.com/hadleywickham/status/1091038245775757312) "...
identity() only has a single arg so as is you’ll get an unhelpful error message
if accidentally passed multiple args".
