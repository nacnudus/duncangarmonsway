...
* Parameters at least at the top level are drawn from distributions, and
  the parameters of *those* distributions might be as well, but eventually at
  the bottom the parameters are fixed.
