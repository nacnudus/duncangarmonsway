...
* "every variable essentially interacts with itself, as the impact of change in
  its value will depend upon its current value." *Surely this is ony when the
...
* "While these two possibilites sound different to most humans, your golem
...
* "I'll use very flat priors here, so we get results nearly identical to
  typical maximum likeelihood inference.  This isn't to imply that this is the
...
* "The log link transforms a linear model into a sstrictly positive measurement."
...
'Pathalogical examples' of things going wrong with MCMC, in Chapter 8.  The
